 ...
 * 
 * <p>
 * Py.IContainerControl  为准备作为容器的控件提供接口。
 * 它会为对象生成 controls 属性，这个属性是一个 Py.Control.ControlCollection 类型的值，并将管理当前控件的全部子控件:
 * <ul>
 ...
 * 
 * <p>
 * 下面举个例子说明 Py.IContainerControl 如何工作。
 * 
 * <ol>
...
Py.IContainerControl = {
	...
	initChildren: function(alternativeName){
		this.controls = this[alternativeName] = new Py.Control.ControlCollection(this);
	},
