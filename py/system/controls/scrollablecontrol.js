...
Py.namespace("Py", "ScrollableControl", Py.ContentControl.extend({
	...
	setContent: function(content){
		...
		this.heightFix = Py.Element.getSize(this.getDom(), 'height', 'bp') + Py.Element.getSize(content.getDom(), 'height', 'bp');
		this.widthFix = Py.Element.getSize(this.getDom(), 'width', 'bp') + Py.Element.getSize(content.getDom(), 'width', 'bp');
	...
	setHeaderVisible: function(value) {
		var header = this.header.get('parent'),
			currentState = Py.Element.isHidden(header);
