...
(function(w) {
	...
	apply(e, {
		...
		addNodeMap: function(name, fn, single){
			var next = single ? walk : dir;
			nodeMaps[name] = [function(elem){
				return next(elem, fn, childMap[1], childMap[2]);
			}];
		},
	...
	e.addNodeMap('siblings', function(el) {return elem != el && fn(el);});
